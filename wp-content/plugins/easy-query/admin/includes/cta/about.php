<div class="cta">
	...
	<div class="cta-wrap config">
		<p class="lg"><?php _e('Easy Query is the fastest and simplest way to build complex WordPress queries without writing a single line of code', 'easy-query'); ?>.</p>
		<p>Create a custom query using the <a href="options-general.php?page=easy-query&tab=query-builder">Query Builder</a> then simply place the generated shortcode or <em><strong>WP_Query()</strong></em> directly into a template, content editor or widget area of your theme.</p>
		...
		<ul class="config-nav">
      	...
      	<li><a href="https://wordpress.org/support/plugin/easy-query" target="_blank"><?php _e('Support', 'easy-query'); ?></a></li>
		</ul>
	</div>
</div>